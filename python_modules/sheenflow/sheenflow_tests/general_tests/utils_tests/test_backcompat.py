...
def test_experimental_class_with_methods():
    ...
    with assert_no_warnings():
        assert experimental_class.hello("sheenflow") == "howdy sheenflow"
    ...
    with assert_no_warnings():
        assert experimental_class_with_experimental_function.hello("sheenflow") == "hello sheenflow"

    with pytest.warns(
        ExperimentalWarning,
        match='"goodbye" is an experimental function. It may break in future versions, even between dot releases.',
    ):
        assert experimental_class_with_experimental_function.goodbye("sheenflow") == "goodbye sheenflow"
