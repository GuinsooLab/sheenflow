...
from sheenflow._core.storage.root_input_manager import root_input_manager
...
#
# sheenflow run wipe
# python python_modules/sheenflow/sheenflow_tests/general_tests/compat_tests/test_execution_plan_snapshot.py
#
# cp -r ~/sheenflow-home/history python_modules/sheenflow/sheenflow_tests/general_tests/compat_tests/test_execution_plan_snapshots/<test_name>
