...
def sqlite_storage_config_fn(temp_dir):
    ...
    return {
        ...
        "event_log_storage": {
            "module": "sheenflow._core.storage.event_log",
...
def test_cross_code_location_run_status_sensor(executor):
    ...
    daemon_sensor_defs_name = (
        "sheenflow_tests.daemon_sensor_tests.locations_for_xlocation_sensor_test.daemon_sensor_defs"
    )
    success_job_defs_name = (
        "sheenflow_tests.daemon_sensor_tests.locations_for_xlocation_sensor_test.success_job_def"
    )
