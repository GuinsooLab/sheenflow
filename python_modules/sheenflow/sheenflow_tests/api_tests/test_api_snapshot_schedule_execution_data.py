from sheenflow._api.snapshot_schedule import sync_get_external_schedule_execution_data_ephemeral_grpc
...
def test_external_schedule_execution_data_api_grpc():
    with instance_for_test() as instance:
        with get_bar_repo_handle(instance) as repository_handle:
            ...
            assert to_launch.tags == {"sheenflow/schedule_name": "foo_schedule"}
...
def test_include_execution_time_grpc():
    with instance_for_test() as instance:
        with get_bar_repo_handle(instance) as repository_handle:
            ...
            assert to_launch.tags == {"sheenflow/schedule_name": "foo_schedule_echo_time"}
