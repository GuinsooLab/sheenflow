...
pytest.register_assert_rewrite("sheenflow_tests.storage_tests.utils.event_log_storage")
from . import event_log_storage  # isort:skip

pytest.register_assert_rewrite("sheenflow_tests.storage_tests.utils.run_storage")
