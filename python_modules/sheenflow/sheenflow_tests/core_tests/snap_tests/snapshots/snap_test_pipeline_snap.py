      ...
      "Shape.081354663b9d4b8fbfd1cb8e358763912953913f": {
        ...
        "fields": [
          ...
          },
          {
            "__class__": "ConfigFieldSnap",
            "default_provided": true,
            "default_value_as_json_str": "\\"sheenflow\\"",
        ...
        "fields": [
          {
            "__class__": "ConfigFieldSnap",
            "default_provided": true,
            "default_value_as_json_str": "{\\"log_level\\": \\"INFO\\", \\"name\\": \\"sheenflow\\"}",
        ...
        "fields": [
          {
            ...
            "default_provided": false,
            "default_value_as_json_str": null,
            "description": "Explicitly specify the modules to preload in the forkserver. Otherwise, there are two cases for default values if modules are not specified. If the Dagster job was loaded from a module, the same module will be preloaded. If not, the `sheenflow` module is preloaded.",
            "is_required": false,
