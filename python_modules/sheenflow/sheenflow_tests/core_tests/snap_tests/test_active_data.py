...
from sheenflow import daily_partitioned_config, job, repository
...
@mock.patch("sheenflow._core.host_representation.pipeline_index.create_pipeline_snapshot_id")
