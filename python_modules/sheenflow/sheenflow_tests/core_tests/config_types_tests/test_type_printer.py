from sheenflow import Field, GraphDefinition, Int, Map, Noneable, ScalarUnion, String, op
...
# launch in sheenlet with this command:
# sheenlet -f test_type_printer.py -n define_test_type_pipeline
