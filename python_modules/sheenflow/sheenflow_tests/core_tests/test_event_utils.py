...
def test_filter_dagster_events_from_cli_logs():
    ...
    sameple_output = """
    2020-07-17 11:31:58 - sheenflow - DEBUG - foo - new_run - STEP_START - Started execution of step "do_something".
                 pid = 2467
               solid = "do_something"
...
2020-07-17 11:31:58 - sheenflow - DEBUG - foo - new_run - STEP_OUTPUT - Yielded output "result" of type "Any". (Type check passed).
...
2020-07-17 11:31:58 - sheenflow - DEBUG - foo - new_run - STEP_SUCCESS - Finished execution of step "do_something" in 13ms.
...
2020-07-17 11:31:58 - sheenflow - DEBUG - foo - new_run - STEP_START - Started execution of step "do_input".
                 pid = 2467
               solid = "do_input"
...
2020-07-17 11:31:58 - sheenflow - DEBUG - foo - new_run - STEP_INPUT - Got input "x" of type "Any". (Type check passed).
...
2020-07-17 11:31:58 - sheenflow - DEBUG - foo - new_run - STEP_SUCCESS - Finished execution of step "do_input" in 13ms.
