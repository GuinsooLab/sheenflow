...
from sheenflow._core.host_representation import GrpcServerRepositoryLocation
from sheenflow._core.test_utils import instance_for_test
from sheenflow._core.workspace.context import WorkspaceProcessContext
from sheenflow._core.workspace.load import (
...
load_from:
    ...
    - python_module:
        executable_path: {executable}
        module_name: sheenflow.utils.test.hello_world_repository
    ...
    - python_module:
        executable_path: {executable}
        module_name: sheenflow.utils.test.named_hello_world_repository
...
def test_multi_location_origins(config_source):
    ...
    assert (
        ...
        == "sheenflow.utils.test.hello_world_repository"
    )
