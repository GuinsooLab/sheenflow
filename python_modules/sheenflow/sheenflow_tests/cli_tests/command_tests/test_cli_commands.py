...
def _default_cli_test_instance_tempdir(temp_dir, overrides=None):
    ...
    with instance_for_test(
        ...
        with mock.patch("sheenflow._core.instance.DagsterInstance.get") as _instance:
...
def python_bar_cli_args(job_name=None):
    args = [
        "-m",
        "sheenflow_tests.cli_tests.command_tests.test_cli_commands",
        "-a",
        "bar",
    ]
    if job_name:
...
def valid_job_python_origin_target_args():
    ...
    return [
        ...
        },
        {
            ...
            "job_name": job_name,
            "python_file": None,
            "module_name": ("sheenflow_tests.cli_tests.command_tests.test_cli_commands",),
            "attribute": "bar",
        },
        {
            "workspace": None,
        ...
        },
        {
            ...
            "job_name": job_name,
            "python_file": None,
            "package_name": "sheenflow_tests.cli_tests.command_tests.test_cli_commands",
            "attribute": "bar",
        },
        {
            "workspace": None,
...
def valid_job_python_origin_target_cli_args():
    return [
        ...
        ["-m", "sheenflow_tests.cli_tests.command_tests.test_cli_commands", "-j", "qux"],
        [
            "-f",
            file_relative_path(__file__, "test_cli_commands.py"),
            "-a",
...
def runner_job_execute(runner, cli_args):
    ...
    if result.exit_code != 0:
        ...
        raise Exception(
            (
                "sheenflow job execute commands with cli_args {cli_args} "
