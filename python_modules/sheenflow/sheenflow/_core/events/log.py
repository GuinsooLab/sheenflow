...
class EventLogEntrySerializer(DefaultNamedTupleSerializer):
    ...
    def value_to_storage_dict(
        ...
        # include an empty string for the message field to allow older versions of sheenflow to load the events
...
class EventLogEntry(
    ...
    def get_dagster_event(self) -> DagsterEvent:
        if not isinstance(self.dagster_event, DagsterEvent):
            check.failed(
                "Not a sheenflow event, check is_dagster_event before calling get_dagster_event",
            )
