...
class DagsterRunMetadataValue(
    ...
    """Representation of a sheenflow run.
...
class DagsterAssetMetadataValue(
    ...
    """Representation of a sheenflow asset.

    Args:
        asset_key (AssetKey): The sheenflow asset key
    """
    ...
    **NOTE**: MetadataEntry static constructors are deprecated. Instead you should use:
    ...
    Args:
        ...
        value (MetadataValue): Typed metadata entry data. The different types allow
            for customized display in tools like sheenlet.
    """
