...
class ScheduleEvaluationContext:
    """The context object available as the first argument various functions defined on a :py:class:`sheenflow.ScheduleDefinition`.

    A `ScheduleEvaluationContext` object is passed as the first argument to ``run_config_fn``, ``tags_fn``,
    and ``should_execute``.

    Users should not instantiate this object directly. To construct a `ScheduleEvaluationContext` for testing purposes, use :py:func:`sheenflow.build_schedule_context`.
    ...
    .. code-block:: python
        ...
        from sheenflow import schedule, ScheduleEvaluationContext
    ...
    def instance(self) -> "DagsterInstance":
        ...
        if not self._instance_ref:
            raise DagsterInvariantViolationError(
                "Attempted to initialize sheenflow instance, but no instance reference was provided."
            )
...
def build_schedule_context(
    ...
    Args:
        instance (Optional[DagsterInstance]): The sheenflow instance configured to run the schedule.
...
class ScheduleDefinition:
    ...
    Args:
        ...
        execution_fn (Callable[ScheduleEvaluationContext]): The core evaluation function for the
            ...
            not. Takes a :py:class:`~sheenflow.ScheduleEvaluationContext`.
        ...
        tags_fn (Optional[Callable[[ScheduleEvaluationContext], Optional[Mapping[str, str]]]]): A
            ...
            :py:class:`~sheenflow.ScheduleEvaluationContext` and returns a dictionary of tags (string
        ...
        should_execute (Optional[Callable[[ScheduleEvaluationContext], bool]]): A function that runs
            ...
            a :py:class:`~sheenflow.ScheduleEvaluationContext` and returns a boolean (``True`` if the
