...
def build_run_status_sensor_context(
    ...
    Args:
        ...
        dagster_instance (DagsterInstance): The sheenflow instance configured for the context.
...
def run_failure_sensor(
    ...
    Takes a :py:class:`~sheenflow.RunFailureSensorContext`.
...
class RunStatusSensorDefinition(SensorDefinition):
    ...
    Args:
        ...
        run_status_sensor_fn (Callable[[RunStatusSensorContext], Union[SkipReason, PipelineRunReaction]]): The core
            evaluation function for the sensor. Takes a :py:class:`~sheenflow.RunStatusSensorContext`.
        minimum_interval_seconds (Optional[int]): The minimum number of seconds that will elapse
            between sensor evaluations.
        description (Optional[str]): A human-readable description of the sensor.
...
def run_status_sensor(
    ...
    Takes a :py:class:`~sheenflow.RunStatusSensorContext`.
