...
class SensorEvaluationContext:
    """The context object available as the argument to the evaluation function of a :py:class:`sheenflow.SensorDefinition`.

    Users should not instantiate this object directly. To construct a
    `SensorEvaluationContext` for testing purposes, use :py:func:`sheenflow.
    ...
    .. code-block:: python
        ...
        from sheenflow import sensor, SensorEvaluationContext
...
class SensorDefinition:
    ...
    Args:
        evaluation_fn (Callable[[SensorEvaluationContext]]): The core evaluation function for the
            ...
            not. Takes a :py:class:`~sheenflow.SensorEvaluationContext`.
...
def build_sensor_context(
    ...
    provided, the sheenflow instance must be persistent; DagsterInstance.ephemeral() will result in an
    error.

    Args:
        instance (Optional[DagsterInstance]): The sheenflow instance configured to run the sensor.
