...
def create_execution_structure(
    ...
    node_dict = {
        'giver': <sheenflow._core.definitions.dependency.Solid object>,
        'sleeper_1': <sheenflow._core.definitions.dependency.Solid object>,
        'sleeper_2': <sheenflow._core.definitions.dependency.Solid object>,
        'sleeper_3': <sheenflow._core.definitions.dependency.Solid object>,
        'sleeper_4': <sheenflow._core.definitions.dependency.Solid object>,
        'total': <sheenflow._core.definitions.dependency.Solid object>
    }

    as well as a sheenflow._core.definitions.dependency.DependencyStructure object.
    """
    from .graph_definition import GraphDefinition
    from .node_definition import NodeDefinition
