...
def sensor(
    ...
    *,
    ...
    Takes a :py:class:`~sheenflow.SensorEvaluationContext`.
...
def asset_sensor(
    ...
    *,
    ...
    Takes a :py:class:`~sheenflow.SensorEvaluationContext` and an EventLogEntry corresponding to an
...
def multi_asset_sensor(
    ...
    *,
    ...
    Takes a :py:class:`~sheenflow.MultiAssetSensorEvaluationContext`.
