...
def schedule(
    ...
    *,
    ...
    The decorated function takes in a :py:class:`~sheenflow.ScheduleEvaluationContext` as its only
    ...
    Returns a :py:class:`~sheenflow.ScheduleDefinition`.
    ...
    Args:
        ...
        should_execute (Optional[Callable[[ScheduleEvaluationContext], bool]]): A function that runs at
            ...
            :py:class:`~sheenflow.ScheduleEvaluationContext` and returns a boolean (``True`` if the
...
def monthly_schedule(
    ...
    *,
    ...
    The decorator produces a :py:class:`~sheenflow.PartitionScheduleDefinition`.
