...
def reconstructable(target: Callable[..., "PipelineDefinition"]) -> ReconstructablePipeline:
    """
    Create a :py:class:`~sheenflow._core.definitions.reconstructable.ReconstructablePipeline` from a
    function that returns a :py:class:`~sheenflow.PipelineDefinition`/:py:class:`~sheenflow.JobDefinition`,
    ...
    :py:func:`~sheenflow.reconstructable.build_reconstructable_job` instead, which allows you to
    ...
    .. code-block:: python
        ...
        from sheenflow import job, reconstructable
...
def build_reconstructable_job(
    ...
    :py:func:`~sheenflow.reconstructable`, such as those defined by lambdas, in nested scopes (e.g.,
    ...
    :py:func:`~sheenflow.reconstructable`.
    ...
    .. code-block:: python
        ...
        from sheenflow import JobDefinition, job, build_reconstructable_job
