...
class MultiAssetSensorEvaluationContext(SensorEvaluationContext):
    ...
    :py:class:`sheenflow.MultiAssetSensorDefinition`.

    Users should not instantiate this object directly. To construct a
    `MultiAssetSensorEvaluationContext` for testing purposes, use :py:func:`sheenflow.
    ...
    .. code-block:: python
        ...
        from sheenflow import multi_asset_sensor, MultiAssetSensorEvaluationContext
...
class MultiAssetSensorDefinition(SensorDefinition):
    ...
    Users should not instantiate this object directly. To construct a
    `MultiAssetSensorDefinition`, use :py:func:`sheenflow.
    multi_asset_sensor`.
    ...
    Args:
        ...
        asset_materialization_fn (Callable[[MultiAssetSensorEvaluationContext], Union[Iterator[Union[RunRequest, SkipReason]], RunRequest, SkipReason]]): The core
            ...
            run should be launched or not. Takes a :py:class:`~sheenflow.MultiAssetSensorEvaluationContext`.
