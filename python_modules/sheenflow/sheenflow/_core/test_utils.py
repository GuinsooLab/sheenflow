...
def instance_for_test(
    ...
    """Creates a persistent :py:class:`~sheenflow.DagsterInstance` available within a context manager.
    ...
    with ExitStack() as stack:
        ...
        instance_overrides = merge_dicts(
            {
                "run_launcher": {
                    ...
                    "module": "sheenflow._core.launcher.default_run_launcher",
                    "config": {
        ...
        with open(os.path.join(temp_dir, "sheenflow.yaml"), "w", encoding="utf8") as fd:
