...
def fs_io_manager(init_context):
    ...
    * A "storage/" directory underneath the value for "local_artifact_storage" in your sheenflow.yaml
    ...
    * A temporary directory.
    ...
    .. code-block:: python
        ...
        from sheenflow import asset, fs_io_manager, repository, with_resources
    ...
    .. code-block:: python
        ...
        from sheenflow import fs_io_manager, job, op, Out
...
def custom_path_fs_io_manager(init_context):
    ...
    .. code-block:: python
        ...
        from sheenflow import custom_path_fs_io_manager, job, op
