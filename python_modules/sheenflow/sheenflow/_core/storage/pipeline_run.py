...
class DagsterRun(
    ...
    """Serializable internal representation of a sheenflow run, as stored in a
    :py:class:`~sheenflow._core.storage.runs.RunStorage`.
    """
    ...
    def tags_for_storage(self):
        ...
        if self.external_pipeline_origin:
            ...
            # per-repository filtering of runs from sheenlet.
            repository_tags[
                REPOSITORY_LABEL_TAG
