...
class AssetRecord(NamedTuple):
    """Internal representation of an asset record, as stored in a :py:class:`~sheenflow._core.storage.event_log.EventLogStorage`.
...
class EventLogStorage(ABC, MayHaveInstanceWeakref):
    ...
    :py:class:`~sheenflow._core.storage.event_log.SqlEventLogStorage`.
    ...
    def get_logs_for_run(
        ...
        Args:
            ...
            of_type (Optional[DagsterEventType]): the sheenflow event type to filter the logs.
