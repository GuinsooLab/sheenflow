...
class SqliteEventLogStorage(SqlEventLogStorage, ConfigurableClass):
    ...
    This is the default event log storage when none is specified in the ``sheenflow.yaml``.
    ...
    def _initdb(self, engine):
        ...
        while True:
            try:
                ...
                # multiple processes (e.g. the sheenlet process and user code process) contend with
