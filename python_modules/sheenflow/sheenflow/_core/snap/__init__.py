...
2) Access metadata about sheenflow artifiacts that are resident in an external
process or container. For example, sheenlet uses these classes load and represent
...
communicated between user repositories and host processes such as sheenlet.
