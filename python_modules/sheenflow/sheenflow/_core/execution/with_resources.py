...
def with_resources(
    ...
    """Adds sheenflow resources to copies of resource-requiring sheenflow definitions.
    ...
    Args:
        ...
        resource_defs (Mapping[str, ResourceDefinition]):
            ...
            resource requirements of provided sheenflow definitions.
    ...
    .. code-block:: python
        ...
        from sheenflow import asset, resource, with_resources
