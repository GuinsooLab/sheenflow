...
class OutputContext:
    ...
    :py:func:`sheenflow.build_output_context`.
    ...
    .. code-block:: python
        ...
        from sheenflow import IOManager, OutputContext
    ...
    def log_event(
        ...
        .. code-block:: python
            ...
            from sheenflow import IOManager, AssetMaterialization
    ...
    def get_logged_events(
        ...
        **Examples:**
        ...
        .. code-block:: python
            ...
            from sheenflow import IOManager, build_output_context, AssetMaterialization
    ...
    def add_output_metadata(self, metadata: Mapping[str, RawMetadataValue]) -> None:
        ...
        .. code-block:: python
            ...
            from sheenflow import IOManager
