...
class UnboundOpExecutionContext(OpExecutionContext):
    ...
    def pdb(self) -> ForkedPdb:
        """sheenflow.utils.forked_pdb.ForkedPdb: Gives access to pdb debugging from within the solid.
    ...
    def get_events(self) -> Sequence[UserEvent]:
        ...
        **Examples:**
        ...
        .. code-block:: python
            ...
            from sheenflow import op, build_op_context, AssetMaterialization, ExpectationResult
