...
Not every property on these should be exposed to random Jane or Joe sheenflow user
...
class StepExecutionContext(PlanExecutionContext, IStepContext):
    ...
    def _get_source_run_id_from_logs(self, step_output_handle: StepOutputHandle) -> Optional[str]:
        ...
        # "re-execute" runs with steps where the outputs weren't previously stored by sheenflow.
