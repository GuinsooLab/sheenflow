...
class InitResourceContext:
    """The context object available as the argument to the initialization function of a :py:class:`sheenflow.ResourceDefinition`.

    Users should not instantiate this object directly. To construct an `InitResourceContext` for testing purposes, use :py:func:`sheenflow.build_init_resource_context`.
    ...
    Attributes:
        ...
        resources (ScopedResources): The resources that are available to the resource that we are
            initalizing.
        dagster_run (Optional[PipelineRun]): The sheenflow run to use. When initializing resources
        ...
        run_id (Optional[str]): The id for this run of the job or pipeline. When initializing resources
            outside of execution context, this will be None.
        pipeline_run (Optional[PipelineRun]): (legacy) The sheenflow run to use. When initializing resources
            outside of execution context, this will be None.
    ...
    .. code-block:: python
        ...
        from sheenflow import resource, InitResourceContext
...
def build_init_resource_context(
    ...
    Args:
        ...
        instance (Optional[DagsterInstance]): The sheenflow instance configured for the context.
