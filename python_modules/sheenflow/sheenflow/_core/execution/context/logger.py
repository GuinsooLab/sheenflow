...
class InitLoggerContext:
    """The context object available as the argument to the initialization function of a :py:class:`sheenflow.LoggerDefinition`.

    Users should not instantiate this object directly. To construct an
    `InitLoggerContext` for testing purposes, use :py:func:`sheenflow.
    ...
    .. code-block:: python
        ...
        from sheenflow import logger, InitLoggerContext
