...
def execute_job(
    ...
    This API represents sheenflow's python entrypoint for out-of-process
    execution. For most testing purposes, :py:meth:`~sheenflow.JobDefinition.
    execute_in_process` will be more suitable, but when wanting to run
    execution using an out-of-process executor (such as :py:class:`sheenflow.
    ...
    wrapping the ``JobDefinition`` in a call to :py:func:`sheenflow.
    reconstructable`.

    .. code-block:: python

        from sheenflow import DagsterInstance, execute_job, job, reconstructable
    ...
    If using the :py:meth:`~sheenflow.GraphDefinition.to_job` method to
    ...
    .. code-block:: python
        ...
        from sheenflow import graph, reconstructable
    ...
    .. code-block:: python
        ...
        from sheenflow import execute_job
    ...
    .. code-block:: python
        ...
        from sheenflow import ReexecutionOptions, execute_job
...
def execute_plan(
    ...
    """This is the entry point of sheenflow-graphql executions. For the sheenflow CLI entry point, see
...
class ExecuteRunWithPlanIterable:
    ...
    cf. `sheenflow._utils.EventGenerationManager`.
    """
