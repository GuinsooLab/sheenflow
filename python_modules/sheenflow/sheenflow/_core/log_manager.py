...
def get_dagster_meta_dict(
    ...
    # combine all sheenflow meta information into a single dictionary
    meta_dict = {
...
class DagsterLogHandler(logging.Handler):
    ...
    def _convert_record(self, record: logging.LogRecord) -> logging.LogRecord:
        ...
        # set the sheenflow meta info for the record
        setattr(
            record,
            DAGSTER_META_KEY,
        ...
        # update the message to be formatted like other sheenflow logs
