...
All errors thrown by the Dagster framework inherit from :py:class:`~sheenflow.DagsterError`. Users
should not subclass this base class for their own exceptions.

There is another exception base class, :py:class:`~sheenflow.DagsterUserCodeExecutionError`, which is
used by the framework in concert with the :py:func:`~sheenflow._core.errors.user_code_error_boundary`.
...
:py:class:`~sheenflow.DagsterUserCodeExecutionError`.
...
This value can be a:
    - Field
    - Python primitive types that resolve to sheenflow config types
        - int, float, bool, str, list.
    - A sheenflow config type: Int, Float, Bool, Array, Optional, Selector, Shape, Permissive, Map
...
class DagsterInvalidConfigDefinitionError(DagsterError):
    ...
    Acceptable values for config types are any of:
        ...
        2. A Dagster config type: :py:data:`~sheenflow.Int`, :py:data:`~sheenflow.Float`,
            :py:data:`~sheenflow.Bool`, :py:data:`~sheenflow.String`,
            :py:data:`~sheenflow.StringSource`, :py:data:`~sheenflow.Any`,
            :py:class:`~sheenflow.Array`, :py:data:`~sheenflow.Noneable`, :py:data:`~sheenflow.Enum`,
            :py:class:`~sheenflow.Selector`, :py:class:`~sheenflow.Shape`, or
        ...
        5. An instance of :py:class:`~sheenflow.Field`.
    """
...
class DagsterResourceFunctionError(DagsterUserCodeExecutionError):
    ...
    :py:class:`~sheenflow.ResourceDefinition` during resource initialization.
    """
...
class DagsterConfigMappingFunctionError(DagsterUserCodeExecutionError):
    ...
    function defined in a :py:class:`~sheenflow.JobDefinition` or `~sheenflow.GraphDefinition` during
    config parsing.
    """
...
class DagsterTypeLoadingError(DagsterUserCodeExecutionError):
    ...
    function defined in a :py:class:`~sheenflow.DagsterTypeLoader` during loading of a custom type.
    """
...
class DagsterTypeMaterializationError(DagsterUserCodeExecutionError):
    ...
    materialization function defined in a :py:class:`~sheenflow.DagsterTypeMaterializer` during
...
class DagsterUnmetExecutorRequirementsError(DagsterError):
    ...
    such as the :py:class:`~sheenflow._core.instance.DagsterInstance` or system storage configuration.
    """


class DagsterSubprocessError(DagsterError):
    """An exception has occurred in one or more of the child processes sheenflow manages.
...
class DagsterTypeCheckDidNotPass(DagsterError):
    ...
    within a test), and a :py:class:`~sheenflow.DagsterType`'s type check fails by returning either
    ``False`` or an instance of :py:class:`~sheenflow.TypeCheck` whose ``success`` member is ``False``.
    """

    def __init__(self, description=None, metadata_entries=None, dagster_type=None):
        from sheenflow import DagsterType, MetadataEntry
