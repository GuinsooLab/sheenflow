...
class DagsterChecker(BaseChecker):
    ...
    msgs = {
        ...
        "W0003": (
            ...
            "pendulum-create",
            (
                "Use sheenflow.seven.compat.pendulum.create_pendulum_time instead of "
        ...
        "W0004": (
            ...
            "pendulum-in-tz",
            (
                "Use sheenflow.seven.compat.pendulum.to_timezone instead of calling in_tz on a "
                "pendulum datetime"
            ),
        ),
    }
...
def register_solid_transform():
    def _is_solid_or_op(node):
        if not node.decorators:
            return False
        return (
            "sheenflow._core.definitions.decorators.solid.solid" in node.decoratornames()
            or "sheenflow._core.definitions.decorators.solid._Solid" in node.decoratornames()
            or "sheenflow._core.definitions.decorators.composite_solid._CompositeSolid"
            in node.decoratornames()
            or "sheenflow._core.definitions.decorators.composite_solid.composite_solid"
            in node.decoratornames()
            or "sheenflow._core.definitions.decorators.op.op" in node.decoratornames()
            or "sheenflow._core.definitions.decorators.op._Op" in node.decoratornames()
            or "sheenflow._core.definitions.decorators.graph.graph" in node.decoratornames()
            or "sheenflow._core.definitions.decorators.graph._Graph" in node.decoratornames()
        )
