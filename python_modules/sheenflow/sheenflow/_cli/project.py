...
def project_cli():
    """
    Commands for bootstrapping new Sheenflow projects and code locations.
    """
...
def scaffold_repository_command(name: str):
    ...
    click.echo(
        click.style(
            "WARNING: This command is deprecated. Use `sheenflow project scaffold-code-location` instead.",
            fg="yellow",
        )
    )
...
def from_example_list_command():
    click.echo("Examples available in `sheenflow project from-example`:")
