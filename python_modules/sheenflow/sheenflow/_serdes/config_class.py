...
class ConfigurableClassData(
    ...
    :py:class:`sheenflow.serdes.ConfigurableClass` mixin.
    """
...
class ConfigurableClass(ABC):
    ...
    of conditional imports / optional extras_requires in sheenflow core and b) a magic directory or
    ...
    def config_type(cls) -> "ConfigType":
        """sheenflow.ConfigType: The config type against which to validate a config yaml fragment
    ...
    def from_config_value(inst_data: Any, config_value: Mapping[str, object]) -> object:
        ...
        Args:
            config_value (dict): The validated config value to use. Typically this should be the
                ...
                :py:class:`~sheenflow._core.types.evaluator.evaluation.EvaluateValueResult`.
