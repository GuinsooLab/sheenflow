from sheenflow_airbyte.resources import DEFAULT_POLL_INTERVAL_SECONDS
from sheenflow_airbyte.types import AirbyteOutput
from sheenflow_airbyte.utils import _get_attempt, generate_materializations
...
def airbyte_sync_op(context):
    ...
    It requires the use of the :py:class:`~sheenflow_airbyte.airbyte_resource`, which allows it to
    ...
    .. code-block:: python
        ...
        from sheenflow_airbyte import airbyte_resource, airbyte_sync_op
