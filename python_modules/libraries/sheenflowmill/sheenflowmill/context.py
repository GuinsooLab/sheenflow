...
class DagstermillExecutionContext(AbstractComputeExecutionContext):
    ...
    Do not initialize directly: use :func:`sheenflowmill.get_context`.
    """
    ...
    def job_def(self) -> JobDefinition:
        ...
        This will be a sheenflowmill-specific shim.
        """
        return cast(
            JobDefinition,
            check.inst(
    ...
    def op_def(self) -> OpDefinition:
        ...
        In interactive contexts, this may be a sheenflowmill-specific shim, depending whether an
        op definition was passed to ``sheenflowmill.get_context``.
        """
    ...
    def solid_def(self) -> OpDefinition:
        ...
        In interactive contexts, this may be a sheenflowmill-specific shim, depending whether a
        solid definition was passed to ``sheenflowmill.get_context``.
        """
        deprecation_warning(
