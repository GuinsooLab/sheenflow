...
def test_databricks_submit_job_existing_cluster(mock_submit_run, databricks_run_config):
    ...
    mock_submit_run.assert_called_with(
        ...
        libraries=[
            {"pypi": {"package": "sheenflow=={}".format(dagster.__version__)}},
            {"pypi": {"package": "sheenflow-databricks=={}".format(dagster.__version__)}},
            {"pypi": {"package": "sheenflow-pyspark=={}".format(dagster.__version__)}},
        ],
    )
