...
from sheenflow import DagsterType, MetadataEntry, TypeCheck
...
class Constraint:
    ...
    Args:
        ...
        markdown_description (Optional[str]): A markdown supported description that is emitted by sheenlet if the constraint fails.
    """
