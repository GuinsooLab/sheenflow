...
def test_get_parameters_by_path(mock_ssm_client):
    mock_ssm_client.put_parameter(Name="path/based/param1", Value="param1")
    mock_ssm_client.put_parameter(Name="path/based/nested/param2", Value="param2")
    mock_ssm_client.put_parameter(Name="path/not/matching/param3", Value="param3")
