...
@mock.patch(
    "sheenflow_aws.emr.emr.EmrJobRunner.is_emr_step_complete", side_effect=[False, False, True]
)
@mock.patch(
    "sheenflow_aws.emr.pyspark_step_launcher.EmrPySparkStepLauncher.read_events",
