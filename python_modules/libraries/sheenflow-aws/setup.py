...
def get_version() -> str:
    ...
    with open(Path(__file__).parent / "sheenflow_aws/version.py", encoding="utf8") as fp:
...
setup(
    ...
    url="https://github.com/GuinsooLab/sheenflow/tree/main/python_modules/libraries/sheenflow_aws",
    classifiers=[
    ...
    packages=find_packages(exclude=["sheenflow_aws_tests*"]),
