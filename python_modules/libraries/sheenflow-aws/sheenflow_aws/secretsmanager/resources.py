...
from sheenflow import Array, Field, Noneable
...
def secretsmanager_resource(context):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from sheenflow_aws.secretsmanager import secretsmanager_resource
...
def secretsmanager_secrets_resource(context):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            import os
            from sheenflow import build_op_context, job, op
            from sheenflow_aws.secretsmanager import secretsmanager_secrets_resource
