...
from sheenflow._core.events import AssetLineageInfo, DagsterEventType
from sheenflow._core.execution.plan.objects import ErrorSource
...
class GrapheneLogsCapturedEvent(graphene.ObjectType):
    ...
    # renamed to fileKey for newer versions of sheenlet
...
class AssetEventMixin:
    ...
    runOrError = graphene.NonNull("sheenflow_graphql.schema.pipelines.pipeline.GrapheneRunOrError")
