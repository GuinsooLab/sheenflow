...
from sheenflow._core.host_representation.external import ExternalExecutionPlan, ExternalPipeline
from sheenflow._core.host_representation.external_data import ExternalPresetData
from sheenflow._core.storage.pipeline_run import DagsterRunStatus, RunRecord, RunsFilter
...
class GrapheneAsset(graphene.ObjectType):
    ...
    definition = graphene.Field("sheenflow_graphql.schema.asset_graph.GrapheneAssetNode")
...
class GraphenePipeline(GrapheneIPipelineSnapshotMixin, graphene.ObjectType):
    ...
    repository = graphene.NonNull("sheenflow_graphql.schema.external.GrapheneRepository")
