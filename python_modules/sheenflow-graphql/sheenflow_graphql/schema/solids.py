...
class GrapheneISolidDefinition(graphene.Interface):
    ...
    asset_nodes = non_null_list("sheenflow_graphql.schema.asset_graph.GrapheneAssetNode")
...
class GrapheneSolidContainer(graphene.Interface):
    ...
    modes = non_null_list("sheenflow_graphql.schema.pipelines.mode.GrapheneMode")
