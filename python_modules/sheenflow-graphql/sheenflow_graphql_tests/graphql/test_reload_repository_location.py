...
class TestReloadWorkspace(MultiLocationTestSuite):
    def test_reload_workspace(self, graphql_context):
        ...
        with mock.patch(
            "sheenflow._core.workspace.load_target.location_origins_from_yaml_paths",
        ) as origins_mock:
...
class TestReloadRepositoriesOutOfProcess(OutOfProcessTestSuite):
    def test_out_of_process_reload_location(self, graphql_context):
        ...
        with mock.patch(
            ...
            "sheenflow._core.host_representation.repository_location.sync_list_repositories_grpc"
        ) as cli_command_mock:
            ...
            with mock.patch(
                ...
                # where it is defined.
                # see https://docs.python.org/3/library/unittest.mock.html#where-to-patch
                "sheenflow._core.host_representation.repository_location.sync_get_streaming_external_repositories_data_grpc"
