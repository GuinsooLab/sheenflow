...
from sheenflow._core.storage.event_log.sqlite import ConsolidatedSqliteEventLogStorage
...
from sheenflow._utils.test import FilesystemTestScheduler
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                with instance_for_test(
                    ...
                    overrides={
                        ...
                        "run_launcher": {
                            "module": "sheenflow._core.launcher.sync_in_memory_run_launcher",
...
class GraphQLContextVariant:
    ...
    e.g.
    pytest python_modules/sheenflow-graphql/sheenflow_graphql_tests/ -s -k in_memory_in_process_start
...
def make_graphql_context_test_suite(context_variants):
    """
        ...
        This is the base class factory for test suites in the sheenflow-graphql test.
    ...
    class _SpecificTestSuiteBase(_GraphQLContextTestSuite):
        ...
        def yield_graphql_client(self, graphql_context):
            ...
            with patch("sheenflow_graphql.client.client.Client") as mock_client:
